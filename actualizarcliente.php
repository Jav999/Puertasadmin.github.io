    ...
    <body background = "fondo6.jpg">
                ...
                <div class="col-md-4">
                    ...
                    <h1 >Actualizar datos</h1>
                                ...
                                <input type="text" class="form-control mb-2" name="nombre"  value="<?php echo $row['Nombre_Cliente']  ?>" required>
                            ...
                            <a href="principalcliente.php" class="btn btn-primary">Regresar</a>
                    </form>
                    </div>
                </div>
    </body>
